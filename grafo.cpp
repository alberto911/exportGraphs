...
void GraphML(DGraph g) {
	std::ofstream file ("amazon.graphml");
	if (file.is_open()) {
...
int main() {
	DGraph dg = TSnap::LoadEdgeList<DGraph>("amazon0302.txt",0,1);
